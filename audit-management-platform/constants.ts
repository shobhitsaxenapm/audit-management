...
export const detailedControlData: Record<string, ControlFullDetail> = {
    ...
    'ITGC-02': {
        overview: { controlId: "ITGC-02", controlName: "Terminated User Access Revocation", description: "User access is revoked for terminated employees within 24 hours of their last day.", classification: "Key Control", assertions: ["Completeness", "Accuracy", "Validity"] },
        attributes: [
    ...
    'ITGC-03': {
        overview: { controlId: "ITGC-03", controlName: "Privileged Access Review", description: "Quarterly review of users with privileged access is performed to ensure continued business need.", classification: "Key Control", assertions: ["Completeness", "Authorization"] },
        attributes: [
            { attributeId: 1, name: 'Quarterly Review Completion', mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.reviewCompleted === true },
            { attributeId: 2, name: 'System Owner Sign-off', mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.isSignedOff === true },
            { attributeId: 3, name: 'Revocation of Inappropriate Access', mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.revokedIfInappropriate === true }
        ],
    ...
    'ITGC-04': {
        overview: { controlId: "ITGC-04", controlName: "Password Configuration", description: "System settings enforce password complexity, length, and history according to policy.", classification: "Non-Key Control", assertions: ["Completeness"] },
        attributes: [
    ...
    'ITGC-05': {
        overview: { controlId: "ITGC-05", controlName: "Change Management - Code Migration", description: "Changes to production systems are approved and tested prior to deployment.", classification: "Key Control", assertions: ["Accuracy", "Authorization"] },
        attributes: [
    ...
    'ITGC-06': {
        overview: { controlId: "ITGC-06", controlName: "Emergency Change Process", description: "Emergency changes follow a documented retrospective approval process within 48 hours.", classification: "Key Control", assertions: ["Completeness", "Authorization"] },
        attributes: [
    ...
    'ITGC-07': {
        overview: { controlId: "ITGC-07", controlName: "Segregation of Duties (IT)", description: "User access roles are designed to prevent conflicting permissions across critical IT processes.", classification: "Key Control", assertions: ["Prevention"] },
        attributes: [
    ...
    'ITGC-08': {
        overview: { controlId: "ITGC-08", controlName: "System Backup Procedures", description: "Critical system data is backed up daily and stored offsite securely.", classification: "Key Control", assertions: ["Availability"] },
        attributes: [
    ...
    'ITGC-09': {
        overview: { controlId: "ITGC-09", controlName: "Batch Job Monitoring", description: "Critical batch jobs are monitored for failure, and deviations are investigated and resolved.", classification: "Non-Key Control", assertions: ["Completeness", "Accuracy"] },
        attributes: [
    ...
    'C-DR-01': {
        overview: { controlId: "C-DR-01", controlName: "Driver Background Verification Check", description: "Verification of driver background details including criminal records and past employment prior to onboarding.", classification: "Key Control", assertions: ["Accuracy", "Timeliness"] },
        attributes: [
            { attributeId: 1, name: "Verify approved access request exists", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.hasRequestForm === true },
            { attributeId: 2, name: "Verify access granted matches request", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.accessMatchesRequest === true },
            { attributeId: 3, name: "Verify access granted within SLA (48h)", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.provisioningHours <= 48 }
        ...
        snapshot: { snapshotId: "SNAP-1041", datasetName: "new_hires_Q1", recordCount: 50, uploadedBy: "S. Lee", uploadDate: "10 Oct 25", status: "Frozen" },
        samples: [
            createMockSample('C-DR-01', 'SNAP-1041', 'ITGC-01-S01', 'E-NEW-01', { employeeId: 'E-NEW-01', hasRequestForm: true, accessMatchesRequest: true, provisioningHours: 24 }),
            createMockSample('C-DR-01', 'SNAP-1041', 'ITGC-01-S02', 'E-NEW-02', { employeeId: 'E-NEW-02', hasRequestForm: true, accessMatchesRequest: true, provisioningHours: 12 }),
            createMockSample('C-DR-01', 'SNAP-1041', 'ITGC-01-S03', 'E-NEW-F1', { employeeId: 'E-NEW-F1', hasRequestForm: false, accessMatchesRequest: true, provisioningHours: 12 }),
            createMockSample('C-DR-01', 'SNAP-1041', 'ITGC-01-S04', 'E-NEW-F2', { employeeId: 'E-NEW-F2', hasRequestForm: true, accessMatchesRequest: false, provisioningHours: 36 }),
            createMockSample('C-DR-01', 'SNAP-1041', 'ITGC-01-S05', 'E-NEW-F3', { employeeId: 'E-NEW-F3', hasRequestForm: true, accessMatchesRequest: true, provisioningHours: 72 })
        ]
    },
    'C-DR-02': {
        overview: { controlId: "C-DR-02", controlName: "Driver Contract Clause Validation", description: "Validation that all mandatory safety and compliance clauses are present in the driver service contracts.", classification: "Key Control", assertions: ["Completeness", "Accuracy", "Validity"] },
        attributes: [
            { attributeId: 1, name: "Verify term date matches HR record", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.terminationDate === sample.sourceRowReference.hrRecordDate },
            { attributeId: 2, name: "Verify ticket creation date", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.ticketId !== null },
            { attributeId: 3, name: "Verify access disabled <= 24h", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.revocationTimeHours <= 24 }
        ...
        snapshot: { snapshotId: "SNAP-1042", datasetName: "hr_terms_Q1", recordCount: 245, uploadedBy: "M. Johnson", uploadDate: "12 Oct 25", status: "Frozen" },
        samples: [
            ...Array.from({ length: 23 }, (_, i) => createMockSample('C-DR-02', 'SNAP-1042', `S-${String(i + 1).padStart(3, '0')}`, `E${String(i + 1).padStart(3, '0')}`, {
                primaryIdentifier: `E${String(i + 1).padStart(3, '0')}`,
                primaryIdentifierLabel: "Employee ID",
                terminationDate: `2025-07-${String((i % 10) + 1).padStart(2, '0')}`,
                hrRecordDate: `2025-07-${String((i % 10) + 1).padStart(2, '0')}`,
            ...
            createMockSample('C-DR-02', 'SNAP-1042', 'S-024', 'E-FAIL-02', {
                primaryIdentifier: "E-FAIL-02",
                primaryIdentifierLabel: "Employee ID",
                terminationDate: "2025-07-11",
                hrRecordDate: "2025-07-11",
            ...
            createMockSample('C-DR-02', 'SNAP-1042', 'S-025', 'E-FAIL-03', {
                 primaryIdentifier: "E-FAIL-03",
                 primaryIdentifierLabel: "Employee ID",
                 terminationDate: "2025-07-12",
                 hrRecordDate: "2025-07-12",
    ...
    'C-DR-03': {
        overview: { controlId: "C-DR-03", controlName: "Driver Insurance Coverage Validation", description: "Periodic verification of driver personal accident and third-party liability insurance coverage.", classification: "Key Control", assertions: ["Existence", "Valuation"] },
        testScript: {
            version: 'TS-v1.2',
        ...
        snapshot: { snapshotId: "SNAP-1043", datasetName: "privileged_access_Q3", recordCount: 120, uploadedBy: "M. Johnson", uploadDate: "13 Oct 25", status: "Frozen" },
        samples: [
            createMockSample('C-DR-03', 'SNAP-1043', 'PR-S01', 'SYS-01', { systemId: 'SYS-01', reviewCompleted: true, isSignedOff: true, revokedIfInappropriate: true, reviewer: 'J. Smith' }),
            createMockSample('C-DR-03', 'SNAP-1043', 'PR-S02', 'SYS-F1', { systemId: 'SYS-F1', reviewCompleted: false, isSignedOff: false, revokedIfInappropriate: true, reviewer: 'A. Patel' }),
            createMockSample('C-DR-03', 'SNAP-1043', 'PR-S03', 'SYS-F2', { systemId: 'SYS-F2', reviewCompleted: true, isSignedOff: false, revokedIfInappropriate: true, reviewer: 'J. Smith' }),
            createMockSample('C-DR-03', 'SNAP-1043', 'PR-S04', 'SYS-04', { systemId: 'SYS-04', reviewCompleted: true, isSignedOff: true, revokedIfInappropriate: true, reviewer: 'B. Jones' })
        ]
    },
    'C-VH-01': {
        overview: { controlId: "C-VH-01", controlName: "Vehicle Registration Validation", description: "Verification that all vehicles in the fleet have valid and current registration documents from the respective motor vehicle department.", classification: "Non-Key Control", assertions: ["Completeness"] },
        attributes: [
            { attributeId: 1, name: "Verify minimum length is >= 12 characters", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.minLength >= 12 },
            { attributeId: 2, name: "Verify complexity is enabled", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.complexityEnabled === true },
            { attributeId: 3, name: "Verify password history is >= 5", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.historyCount >= 5 }
    ...
    'C-VH-02': {
        overview: { controlId: "C-VH-02", controlName: "Vehicle Pollution Certificate Validation", description: "Verification of valid Pollution Under Control (PUC) certificates for all operational vehicles.", classification: "Key Control", assertions: ["Accuracy", "Authorization"] },
        attributes: [
            { attributeId: 1, name: "Verify change request is approved", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.approved === true },
            { attributeId: 2, name: "Verify testing was completed and signed off", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.tested === true },
            { attributeId: 3, name: "Verify segregation of duties between dev and deploy", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.dev !== sample.sourceRowReference.deployer }
        ...
        snapshot: { snapshotId: "SNAP-1045", datasetName: "cm_log_Q3", recordCount: 210, uploadedBy: "K. Singh", uploadDate: "13 Oct 25", status: "Frozen" },
        samples: [
            createMockSample('C-VH-02', 'SNAP-1045', 'ITGC-05-S01', 'CR-001', { changeId: 'CR-001', approved: true, tested: true, dev: 'userA', deployer: 'userB' }),
            createMockSample('C-VH-02', 'SNAP-1045', 'ITGC-05-S02', 'CR-F01', { changeId: 'CR-F01', approved: false, tested: true, dev: 'userC', deployer: 'userD' }),
            createMockSample('C-VH-02', 'SNAP-1045', 'ITGC-05-S03', 'CR-F02', { changeId: 'CR-F02', approved: true, tested: false, dev: 'userE', deployer: 'userF' }),
            createMockSample('C-VH-02', 'SNAP-1045', 'ITGC-05-S04', 'CR-F03', { changeId: 'CR-F03', approved: true, tested: true, dev: 'userG', deployer: 'userG' })
        ]
    },
    'C-VH-03': {
        overview: { controlId: "C-VH-03", controlName: "Vehicle Fitness Certificate Validation", description: "Validation of annual vehicle fitness certificates issued by authorized testing centers.", classification: "Key Control", assertions: ["Completeness", "Authorization"] },
        attributes: [
            { attributeId: 1, name: "Verify change was classified as emergency", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.isEmergency === true },
            { attributeId: 2, name: "Verify retrospective approval was obtained within 48h", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.retroApprovedHours <= 48 }
        ],
        snapshot: { snapshotId: "SNAP-1046", datasetName: "emergency_cm_log_Q3", recordCount: 15, uploadedBy: "K. Singh", uploadDate: "15 Oct 25", status: "Frozen" },
        samples: [
            createMockSample('C-VH-03', 'SNAP-1046', 'ITGC-06-S01', 'ECR-01', { changeId: 'ECR-01', isEmergency: true, retroApprovedHours: 24 }),
            createMockSample('C-VH-03', 'SNAP-1046', 'ITGC-06-S02', 'ECR-02', { changeId: 'ECR-02', isEmergency: true, retroApprovedHours: 4 }),
            createMockSample('C-VH-03', 'SNAP-1046', 'ITGC-06-S03', 'ECR-F01', { changeId: 'ECR-F01', isEmergency: true, retroApprovedHours: 72 }),
            createMockSample('C-VH-03', 'SNAP-1046', 'ITGC-06-S04', 'ECR-F02', { changeId: 'ECR-F02', isEmergency: false, retroApprovedHours: 12 })
        ]
    },
    'C-PT-01': {
        overview: { controlId: "C-PT-01", controlName: "Partner Business Registration Verification", description: "Verification of business registration documents (GST/PAN) for all third-party transport partners.", classification: "Key Control", assertions: ["Prevention"] },
        attributes: [
            { attributeId: 1, name: "Verify user does not have conflicting roles", mandatory: true, ruleLogic: (sample: any) => !sample.sourceRowReference.hasConflict },
            { attributeId: 2, name: "Verify mitigating control is in place if conflict exists", mandatory: false, ruleLogic: (sample: any) => sample.sourceRowReference.hasConflict ? sample.sourceRowReference.mitigatingControlExists : true }
        ],
        snapshot: { snapshotId: "SNAP-1047", datasetName: "user_roles_matrix", recordCount: 850, uploadedBy: "R. Chen", uploadDate: "12 Oct 25", status: "Frozen" },
        samples: [
            createMockSample('C-PT-01', 'SNAP-1047', 'ITGC-07-S01', 'user_a', { userId: 'user_a', hasConflict: false, mitigatingControlExists: false }),
            createMockSample('C-PT-01', 'SNAP-1047', 'ITGC-07-S02', 'user_b', { userId: 'user_b', hasConflict: true, mitigatingControlExists: true }),
            createMockSample('C-PT-01', 'SNAP-1047', 'ITGC-07-S03', 'user_f1', { userId: 'user_f1', hasConflict: true, mitigatingControlExists: false })
        ]
    },
    'C-PT-02': {
        overview: { controlId: "C-PT-02", controlName: "Subcontractor Declaration Verification", description: "Review of signed declarations from transport partners regarding the use of subcontractors.", classification: "Key Control", assertions: ["Availability"] },
        attributes: [
            { attributeId: 1, name: "Verify backup was completed successfully", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.backupStatus === "Success" },
            { attributeId: 2, name: "Verify backup is stored offsite", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.isOffsite === true },
            { attributeId: 3, name: "Verify quarterly restore test was successful", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.restoreTestStatus === "Success" }
        ...
        snapshot: { snapshotId: "SNAP-1048", datasetName: "backup_logs_Q3", recordCount: 500, uploadedBy: "L. Vega", uploadDate: "09 Oct 25", status: "Frozen" },
        samples: [
            createMockSample('C-PT-02', 'SNAP-1048', 'ITGC-08-S01', 'SYS-DB-01', { systemId: 'SYS-DB-01', backupStatus: 'Success', isOffsite: true, restoreTestStatus: 'Success' }),
            createMockSample('C-PT-02', 'SNAP-1048', 'ITGC-08-S02', 'SYS-APP-F1', { systemId: 'SYS-APP-F1', backupStatus: 'Failed', isOffsite: false, restoreTestStatus: 'N/A' }),
            createMockSample('C-PT-02', 'SNAP-1048', 'ITGC-08-S03', 'SYS-WEB-F2', { systemId: 'SYS-WEB-F2', backupStatus: 'Success', isOffsite: false, restoreTestStatus: 'Success' }),
            createMockSample('C-PT-02', 'SNAP-1048', 'ITGC-08-S04', 'SYS-AUTH-F3', { systemId: 'SYS-AUTH-F3', backupStatus: 'Success', isOffsite: true, restoreTestStatus: 'Failed' })
        ]
    },
    'C-PT-03': {
        overview: { controlId: "C-PT-03", controlName: "Security Policy Acknowledgement Verification", description: "Verification that all transport partners have acknowledged the organization's security and privacy policies.", classification: "Non-Key Control", assertions: ["Completeness", "Accuracy"] },
        attributes: [
            { attributeId: 1, name: "Verify job completed successfully", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.jobStatus === "Success" },
            { attributeId: 2, name: "If failed, verify investigation ticket was created", mandatory: true, ruleLogic: (sample: any) => sample.sourceRowReference.jobStatus === "Success" || sample.sourceRowReference.ticketId !== null }
        ],
        snapshot: { snapshotId: "SNAP-1049", datasetName: "batch_job_logs", recordCount: 1500, uploadedBy: "L. Vega", uploadDate: "10 Oct 25", status: "Frozen" },
        samples: [
            createMockSample('C-PT-03', 'SNAP-1049', 'ITGC-09-S01', 'JOB-001', { jobId: 'JOB-001', jobStatus: 'Success', ticketId: null }),
            createMockSample('C-PT-03', 'SNAP-1049', 'ITGC-09-S02', 'JOB-F01', { jobId: 'JOB-F01', jobStatus: 'Failed', ticketId: 'T-BJ-01' }),
            createMockSample('C-PT-03', 'SNAP-1049', 'ITGC-09-S03', 'JOB-F02', { jobId: 'JOB-F02', jobStatus: 'Failed', ticketId: null })
        ]
    }
};
